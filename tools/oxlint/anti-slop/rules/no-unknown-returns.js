  ...
  createOnce(context) {
    ...
    const isDefinitelyAssignable = (
      ...
      if (sourcePrimitive !== null || targetPrimitive !== null) {
        return sourcePrimitive !== null && sourcePrimitive === targetPrimitive;
      }
    ...
    const conditionalUnknown = (type, visited, bindings) => {
    ...
    const resolvesToUnknown = (
      ...
      if (type.type === "TSConditionalType") {
        return conditionalUnknown(type, visited, bindings);
      }
